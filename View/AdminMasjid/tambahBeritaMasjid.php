        ...
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/add/addBeritaMasjidAM.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            <div class="kotak-tengah box span-12">
                                ...
                                <div class="judul box span-12">
                                    ...
                                    <div class="box span-9">
                                        <textarea class="textarea" rows="15" cols="103" name="isiBerita" style="font-size: 12px;"></textarea>
                                    </div>
                                </div>
                                <div class="judul box span-12">
                                    <div class="padding box span-1-5">
