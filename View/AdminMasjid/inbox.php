...
<html>
    <head>
        <title>Inbox Admin Masjid</title>
        ...
        <link rel="stylesheet" href="../css/AdminMasjid/inbox.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/edit/inboxAM.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            ...
                            <div class="slider box span-12">
                                <?php
                                $_SESSION['pesan'] = querySelect('*', 'pesan', 'ke=' . $id_user . ' AND status=0 ORDER BY tanggal_upload DESC', null);
                                            ...
                                            <div class="message box span-12">
                                                <div class="inherit box span-0-5">
                                                    <div class="checkbox center box span-12">
                                                        <input type="checkbox" name="msg[]" class="msg" value="<?php echo $_SESSION['pesan'][$i]['id_pesan']; ?>">
                                                    </div>
                                                </div>
                                                <a class="href-black" href="isiPesanInbox.php?pesan_id=<?php echo $_SESSION['pesan'][$i]['id_pesan']; ?>">
                                                    <div class="jarak box span-2-5">
                                                        Dari : <?php echo $_SESSION['pesan'][$i]['nama_dari'] ?>
                                                    </div>
                                                    <div class="jarak box span-6-5">
                                                        <?php echo $_SESSION['pesan'][$i]['judul'] ?>
                                                    </div>
                                                    <div class="jarak box span-2-5">
                                                        <?php echo $_SESSION['pesan'][$i]['tanggal_upload'] ?>
                                                    </div>
                                                </a>
                                            </div>
                                            <?php
                            ...
                            <div class="button box span-12">
                                ...
                                <?php
                                if ($offset_arrow + 10 < sizeof($_SESSION['pesan'])) {
                                    ?>
            ...
            <meta http-equiv="refresh" content="1.5;url=http://localhost/SIMasjid/view/AdminMasjid/inbox.php" />';
                    } else {
                        echo '<div id="login_popup1">
                <div class="layer-ubahData box span-12">
                </div>
