...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/AdminMasjid/sent.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/edit/sentAM.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            <div class="kotak-judul box span-12">
                                ...
                                <div class="hapus box span-11">
                                    ...
                                    <div class="hapus-text box span-8">
                                        <input id="submit-button" type='submit' class="btn btn-block btn-lg btn-inverse" value='Hapus' name="adminmasjid_hapussent_submit">
                                    </div>
                                </div>
                            </div>
                            <div class="slider box span-12">
                                <?php
                                $_SESSION['pesanSent'] = querySelect('*', 'pesan', 'id_user=' . $id_user . ' AND status=1 ORDER BY tanggal_upload DESC', null);
                                ...
                                $pagination = 0;
                                for ($i = 0; $i < count($_SESSION['pesanSent']); $i++) {
                                    if ($i >= $offset) {
                                        if ($pagination < 10) {
                                            ?>
                                            <div class="message box span-12">
                                                <div class="inherit box span-0-5">
                                                    <div class="checkbox center box span-12">
                                                        <input type="checkbox" name="msg[]" class="msg" value="<?php echo $_SESSION['pesanSent'][$i]['id_pesan']; ?>">
                                                    </div>
                                                </div>
                                                <a class="href-black" href="isiPesanSent.php?pesan_id=<?php echo $_SESSION['pesanSent'][$i]['id_pesan']; ?>">
                                                    <div class="jarak box span-2-5">
                                                        Ke : <?php echo $_SESSION['pesanSent'][$i]['nama_ke'] ?>
                                                    </div>
                                                    <div class="jarak box span-6-5">
                                                        <?php echo $_SESSION['pesanSent'][$i]['judul'] ?>
                                                    </div>
                                                    <div class="jarak box span-2-5">
                                                        <?php echo $_SESSION['pesanSent'][$i]['tanggal_upload'] ?>
                                                    </div>
                                                </a>
                                            </div>
                                            <?php
                            ...
                            <div class="button box span-12">
                                <div class="panah-kiri box span-1">
                                    ...
                                    if ($offset_arrow <= 0) {
                                        ?>
                                        <a href="sent.php?offset=<?php echo $offset - 10; ?>">
                                            &nbsp;
                                        </a>
                                        <?php
                                ...
                                <?php
                                if ($offset_arrow + 10 < sizeof($_SESSION['pesanSent'])) {
                                    ?>
            ...
            <meta http-equiv="refresh" content="1.5;url=http://localhost/SIMasjid/view/AdminMasjid/sent.php" />';
                    } else {
                        echo '<div id="login_popup1">
                <div class="layer-ubahData box span-12">
                </div>
                        ...
                        <table class="tabel">
                            ...
                            <tr>
                                <td class="center jarak-popup">
                                    Tidak ada pesan yang dipilih, silahkan coba kembali.
                                </td>
                            </tr>
                        </table>
