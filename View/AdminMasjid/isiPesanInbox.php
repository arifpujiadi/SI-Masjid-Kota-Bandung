...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/AdminMasjid/isiPesan.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <div class="box span-10-3">
                        ...
                        <div class="balas-text box span-12">
                            ...
                            <div class="balas inherit box span-11">
                                <a href="balasPesan.php?pesan_id=<?php echo $id_pesan; ?>">
                                    <input type='submit' class="btn btn-block btn-lg btn-inverse" value='Balas' name="adminmasjid_balaspesan_submit">
                                </a>
                            </div>
                        </div>
                    </div>
