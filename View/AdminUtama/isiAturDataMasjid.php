...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/AdminUtama/isiAturDataMasjid.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/edit/editDataMasjid.php' enctype="multipart/form-data">
            ...
            $(document).ready(function () {
                ...
                $(".addFile").on("click", function () {
                    $(".targetFile").append('<div class="tambah box span-12">' +
                            ...
                            '</div>' +
                            '<div class="tambah box span-1" style="margin-left: 10px;">' +
                            '   <a id="btn-tambah-rute" class="btn-tambah btn-block-tambah btn-lg-tambah btn-ubah-inverse deleteFile' + num3 + '" onclick="removeIni3(' + num3 + ')">' +
                            '       <img src="../img/Notification/delete.png">' +
                            '   </a>' +
                            '</div>' +
                            '<div class="keterangan box span-2">' +
