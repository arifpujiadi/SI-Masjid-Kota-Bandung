...
$idBerita = $_REQUEST['id_berita_masjid'];
$idMasjid = $_REQUEST['id_masjid'];
$dataBerita = querySelect('*', 'berita_masjid', 'id_berita_masjid =' . $idBerita, null);
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/edit/editBeritaMasjidAU.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            <div class="kotak-tengah box span-12">
                                <div class="kotak-judul box span-12">
                                    Ubah Berita Masjid
                                </div>
                                <input hidden type="text" name="id_masjid" value="<?php echo $idMasjid ?>"/>
                                <input hidden type="text" name="id_berita_masjid" value="<?php echo $idBerita ?>"/>
                                ...
                                <div class="judul box span-12">
                                    ...
                                    <div class="box span-10">
                                        <textarea class="textarea" rows="10" cols="103" name="isiBerita" style="font-size: 12px;"><?php echo str_replace('<br />', "",$dataBerita[0]['isi_berita']); ?></textarea>
                                    </div>
                                </div>
                                <div class="judul box span-12">
                                    <div class="padding box span-1-5">
