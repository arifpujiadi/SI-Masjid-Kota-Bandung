        ...
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='POST' action='../../function/script/edit/editSentAU.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            <div class="kotak-judul box span-12">
                                ...
                                <div class="hapus box span-11">
                                    ...
                                    <div class="hapus-text box span-8">
                                        <input id="submit-button" type='submit' class="btn btn-block btn-lg btn-inverse" value='Hapus' name="adminutama_hapussent_submit">
                                    </div>
                                </div>
                            </div>
                            <div class="slider box span-12">
                                <?php
                                $_SESSION['pesanSentAU'] = querySelect('*', 'pesan', 'id_user=' . $id_user . ' AND status=1 ORDER BY tanggal_upload DESC', null);
                                ...
                                $pagination = 0;
                                for ($i = 0; $i < count($_SESSION['pesanSentAU']); $i++) {
                                    if ($i >= $offset) {
                                        if ($pagination < 10) {
                                            ?>
                                            <div class="message box span-12">
                                                <div class="inherit box span-0-5">
                                                    <div class="checkbox center box span-12">
                                                        <input type="checkbox" name="msg[]" class="msg" value="<?php echo $_SESSION['pesanSentAU'][$i]['id_pesan']; ?>">
                                                    </div>
                                                </div>
                                                <a class="href-black" href="isiPesanSent.php?pesan_id=<?php echo $_SESSION['pesanSentAU'][$i]['id_pesan']; ?>">
                                                    <div class="jarak box span-2-5">
                                                        Ke : <?php echo $_SESSION['pesanSentAU'][$i]['nama_ke'] ?>
                                                    </div>
                                                    <div class="jarak box span-6-5">
                                                        <?php echo $_SESSION['pesanSentAU'][$i]['judul'] ?>
                                                    </div>
                                                    <div class="jarak box span-2-5">
                                                        <?php echo $_SESSION['pesanSentAU'][$i]['tanggal_upload'] ?>
                                                    </div>
                                                </a>
                                            </div>
                                            <?php
                            ...
                            <div class="button box span-12">
                                ...
                                <?php
                                if ($offset_arrow + 10 < sizeof($_SESSION['pesanSentAU'])) {
                                    ?>
            ...
            <meta http-equiv="refresh" content="1.5;url=http://localhost/SIMasjid/view/AdminUtama/sent.php" />';
                    } else {
                        echo '<div id="login_popup1">
                <div class="layer-ubahData box span-12">
                </div>
                        ...
                        <table class="tabel">
                            ...
                            <tr>
                                <td class="center jarak-popup">
                                    Tidak ada pesan sent yang dipilih, silahkan coba kembali.
                                </td>
                            </tr>
                        </table>
