...
<html>
    ...
    <body>
        <?php
        $isi_video_musik = querySelect('*', 'video_musik', 'id_video_musik=' . $_GET['musik_id'], null);
        ?>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form method='GET' action='../../function/script/edit/editVideoMusik.php'>
                        <div class="box span-10-3">
                            <div class="kotak-tengah box span-12">
                                <div class="kotak-judul box span-12">
                                    Ubah Video Musik
                                </div>
                                <input hidden type="text" name="id_video_musik" value="<?php echo $_GET['musik_id'] ?>"/>
                                <div class="judul box span-12">
                                    ...
                                    <div class="box span-10">
                                        <input class="form field judul-video" type="text" placeholder="Judul video" value="<?php echo $isi_video_musik[0]['judul']; ?>" name="judulVideoMusik">
                                    </div>
                                </div>
                                <div class="judul box span-12">
                                    <div class="padding box span-1-5">
                                    ...
                                    <div class="box span-10">
                                        <input class="form field keterangan" type="text" placeholder="Penyanyi" value="<?php echo $isi_video_musik[0]['penyanyi']; ?>" name="penyanyi">
                                    </div>
                                </div>
                                <div class="judul box span-12">
                                    ...
                                    <div class="box span-10">
                                        <textarea class="textarea" rows="9" cols="103" name="embedVideoMusik" style="font-size: 12px;"><?php echo $isi_video_musik[0]['embed']; ?></textarea>
                                    </div>
                                </div>
                                <div class="simpan box span-12">
                                    <input type='submit' class="btn btn-block btn-lg btn-inverse" value='Simpan' name="adminutama_editvideomusik_submit">
                                </div>
                            </div>
                        </div>
                    </form>
