...
<html>
    ...
    <body>
        <div class="wrapper">
            <div class="col-full">
                ...
                <div class="content row">
                    ...
                    <form id="formRegister" method='POST' action='../../function/script/add/addAdminMasjid.php' enctype="multipart/form-data">
                        <div class="box span-10-3">
                            ...
                            <div class="baris-buat box span-12">
                                <div class="buat box span-12">
                                    <input id="submit-button" type='submit' class="btn btn-block btn-lg btn-inverse" value='Buat' name="adminutama_tambahadmin_submit">
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <script src="../js/tambahAdminMasjid.js"></script>
    </body>
</html>