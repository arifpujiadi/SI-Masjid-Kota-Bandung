...
<html>
    <head>
        <title>Video - Informasi Masjid</title>
        ...
        <link rel="stylesheet" href="../css/PenggunaUmum/informasiMasjid.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                                    ...
                                    if ($i >= $offset) {
                                        if ($pagination < 8) {
                                            ...
                                            <div class="kotakVideo box span-3">
                                                <a href="informasiMasjid.php?offset=<?php echo $offset; ?>&vid<?php echo $i; ?>">
                                                    <div class="video-isi">
                                                        <div>
                                                        ...
                                                        <div class="keterangan-video">
                                                            Masjid <?php echo $dataVideo[$i]['nama_masjid'] ?>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="box span-12">
                                            <div class="panah-kiri box span-1">
                                                ...
                                                if ($offset_arrow <= 0) {
                                                    ?>
                                                    <a href="informasiMasjid.php?offset=<?php echo $offset - 8; ?>">
                                                        &nbsp;
                                                    </a>
                                                    <?php
