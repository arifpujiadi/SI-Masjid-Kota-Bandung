...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/PenggunaUmum/ceramah.css">
    </head>
    <body>
        <div class="wrapper">
            <div class="col-full">
                    ...
                    <div class="slideVideo box">
                        <div class="col">
                            <div class="video box span-12">
                                <?php
                                $offset = 0;
                                $dataVideo = querySelect('*', 'video_ceramah ORDER BY tanggal_upload DESC', null, null);
                                    ...
                                    if ($i >= $offset) {
                                        if ($pagination < 8) {
                                            ...
                                            <div class="kotakVideo box span-3">
                                                <a href="ceramah.php?offset=<?php echo $offset; ?>&vid<?php echo $i; ?>">
                                                    <div class="video-isi">
                                                        <div>
                                                        ...
                                                        <div class="keterangan-video">
                                                            <?php echo $dataVideo[$i]['penceramah'] ?>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="box span-12">
                                            <div class="panah-kiri box span-1">
                                                ...
                                                if ($offset_arrow <= 0) {
                                                    ?>
                                                    <a href="ceramah.php?offset=<?php echo $offset - 8; ?>">
                                                        &nbsp;
                                                    </a>
                                                    <?php
