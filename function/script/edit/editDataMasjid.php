...
if ($_REQUEST['id_masjid'] != '' &&
    ...
    if ($update_masjid) {
        header('location:http://localhost/SIMasjid/view/AdminUtama/isiAturDataMasjid.php?ubah=true&id_user=' . $id_user . '&id_masjid=' . $id_masjid . '&status=true');
    }
} else {
    header('location:http://localhost/SIMasjid/view/AdminUtama/isiAturDataMasjid.php?ubah=true&id_user=' . $_REQUEST['id_user'] . '&id_masjid=' . $_REQUEST['id_masjid'] . '&status=false');
}
?>